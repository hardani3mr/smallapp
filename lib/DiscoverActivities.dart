...
class DiscoverActivities extends StatelessWidget {
  DiscoverActivities({
    Key key,
  }) : super(key: key);
  @override
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: const AssetImage('assets/images/17.jpg'),
                                fit: BoxFit.cover,
                ...
                return
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(38.0, 154.0, 60.0, 12.0),
                        size: Size(136.0, 182.0),
                        pinBottom: true,
                        fixedWidth: true,
                        fixedHeight: true,
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(42.0, 136.0, 52.0, 15.0),
                        size: Size(136.0, 182.0),
                        fixedWidth: true,
                        fixedHeight: true,
                        child: Text(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(19.7, 21.0, 112.0, 15.0),
                    size: Size(345.7, 56.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 269.0, 105.0),
                    size: Size(269.0, 105.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(1.0, 0.0, 135.0, 62.0),
                          size: Size(269.0, 105.0),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 87.0, 269.0, 18.0),
                          size: Size(269.0, 105.0),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.5, 72.5, 33.4, 1.0),
                          size: Size(269.0, 105.0),
                          pinLeft: true,
                          fixedWidth: true,
                          fixedHeight: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(248.0, 80.0, 34.0, 10.0),
                    size: Size(375.0, 108.2),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
