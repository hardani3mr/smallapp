...
class HomeSideshow4 extends StatelessWidget {
  HomeSideshow4({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 282.7, 55.1),
                    size: Size(282.7, 55.1),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 14.0, 262.0, 14.0),
                    size: Size(282.7, 55.1),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                    child: Text(
                      'Discover new & learn about new activities ',
                      style: TextStyle(
                        fontFamily: 'Europa',
                        fontSize: 14,
                        color: const Color(0xffffffff),
